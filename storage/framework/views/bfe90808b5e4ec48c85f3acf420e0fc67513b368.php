        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('/assets/images/pemda.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/pemda.png')); ?>" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="/" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/pemda.png')); ?>" alt="" height="19">
                    </span>
                </a>
            </div>
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <img class="rounded-circle header-profile-user" src="<?php echo e(asset('/assets/images/pemda.png')); ?>"
                    alt="Header Avatar">
...
<?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>