...
<?php $__env->startComponent('boilerplate::minify'); ?>
    <script>
        whenAssetIsLoaded('select2', () => {
            window.<?php echo e('S2_'.\Str::camel($id)); ?> = $('#<?php echo e($id); ?>').select2({
                placeholder: '<?php echo e($placeholder ?? '—'); ?>',
                allowClear: <?php echo e($allowClear); ?>,
                language: "<?php echo e(App::getLocale()); ?>",
                direction: "<?php echo app('translator')->get('boilerplate::layout.direction'); ?>",
                minimumInputLength: <?php echo e($minimumInputLength ?? intval(isset($model))); ?>,
                minimumResultsForSearch: <?php echo e($minimumResultsForSearch ?? 10); ?>,
                width: '100%',
                dropdownAutoWidth: true,
                dropdownParent: $('#<?php echo e($id); ?>').parent(),
                tags: <?php echo e($tags ?? 0); ?>,
                ...
                ajax: {
                    ...
                    data: function (param) {
                        return {
                            q: param.term,
                            length: <?php echo e($maxLength ?? 10); ?>,
                            <?php if(isset($model)): ?>
                            m: "<?php echo e($model); ?>",
                            <?php endif; ?>
                            <?php if(!empty($ajaxParams)): ?>
                            <?php $__currentLoopData = $ajaxParams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/select2.blade.php ENDPATH**/ ?>