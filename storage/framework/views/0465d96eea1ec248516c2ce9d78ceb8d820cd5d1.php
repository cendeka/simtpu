    ...
    whenAssetIsLoaded('CodeMirror', () => {
        ...
        intervals[uid] = setInterval(function() {
            if($('#<?php echo e($id); ?>').is(':visible')){
                ...
                window.<?php echo e('CM_'.\Str::camel($id)); ?> = $('#<?php echo e($id); ?>').codemirror({ <?php echo $options ?? ''; ?> });
            }
        });
    })
</script>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/codemirror.blade.php ENDPATH**/ ?>