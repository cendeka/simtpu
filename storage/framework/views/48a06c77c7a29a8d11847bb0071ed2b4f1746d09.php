<?php echo $__env->make('boilerplate-media-manager::load.tinymce', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('boilerplate::load.codemirror', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(() => {
            ...
            $('[name=layout]').on('change', function () {
                $.ajax({
                    url: '<?php echo e(route('emaileditor.email.content')); ?>',
                    type: 'post',
                    data: {
            ...
            $('.btn-preview').on('click', function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('emaileditor.email.preview')); ?>',
                    type: 'post',
                    data: {
                        content: $("#content").tinymce().getContent(),
                    ...
                    success: function () {
                        window.open('<?php echo e(route('emaileditor.email.preview')); ?>', '_blank');
                    }
                });
            });
            ...
            $('.btn-preview-mail').on('click', function () {
                bootbox.prompt({
                    title: "<?php echo e(__('boilerplate-email-editor::editor.mail-prompt')); ?>",
                    placeholder: '<?php echo e($userEmail); ?>',
                    buttons: {
                        confirm: {
                            label: "<?php echo e(__('boilerplate-email-editor::editor.send')); ?>"
                        }
                    },
                    callback: function (result) {
                        if (result !== null) {
                            $.ajax({
                                url: '<?php echo e(route('emaileditor.email.preview.email')); ?>',
                                type: 'post',
                                data: {
                                    content: $("#content").tinymce().getContent(),
                                    layout: $('[name=layout]').val(),
                                ...
                                success: function () {
                                    growl("<?php echo e(__('boilerplate-email-editor::editor.mail-success')); ?>", 'success')
                                }
                            });
                        }
                    }
            ...
            $('#content').tinymce({
                ...
                setup: function (editor) {
                    editor.ui.registry.addButton('insertVar', {
                        text: '<?php echo e(__('boilerplate-email-editor::email.insert_var')); ?>',
                        disabled: true,
                        onAction: function (_) {
                            bootbox.prompt("<?php echo e(__('boilerplate-email-editor::email.var_name')); ?>", function (result) {
                                if (result === null) {
                                    return null;
                                }
        ...
        function loadLayout(content) {
            ...
            $.ajax({
                url: '<?php echo e(route('emaileditor.email.mce', [], false)); ?>',
                type: 'post',
                data: {
                    content: content,
...
<?php $__env->stopPush(); ?><?php /**PATH E:\Repo\simtpu-v2\vendor\sebastienheyd\boilerplate-email-editor\src/resources/views/email/scripts.blade.php ENDPATH**/ ?>