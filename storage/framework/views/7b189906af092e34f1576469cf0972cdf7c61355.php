...
<script>
    whenAssetIsLoaded('daterangepicker', () => {
        window.<?php echo e('DRP_'.\Str::camel($id)); ?> = $('input[name="<?php echo e($name); ?>[value]"]').daterangepicker({
            showDropdowns: true,
...
<?php endif; ?><?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/daterangepicker.blade.php ENDPATH**/ ?>