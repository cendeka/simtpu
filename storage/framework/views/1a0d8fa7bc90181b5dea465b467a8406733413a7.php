...
<script>
    whenAssetIsLoaded('datetimepicker', () => {
        window.<?php echo e('DTP_'.\Str::camel($id)); ?> = $('#<?php echo e($id); ?>').datetimepicker({
...
<?php endif; ?><?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/datetimepicker.blade.php ENDPATH**/ ?>