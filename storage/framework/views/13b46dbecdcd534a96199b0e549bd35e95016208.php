        ...
        <div class="d-flex justify-content-between align-items-start">
            ...
            <div class="dropdown-wrapper">
                <div class="form-group">
                    <?php echo Form::open(['route' => 'boilerplate.lang.switch', 'method' => 'post', 'autocomplete'=> 'off']); ?>
                    ...
                    <select class="form-control form-control-sm" name="lang" onchange="this.form.submit()">
                        <?php $__currentLoopData = collect(config('boilerplate.locale.languages'))->map(function($e){return $e['label'];})->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($lang); ?>" <?php echo e($lang === App::getLocale() ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/auth/login.blade.php ENDPATH**/ ?>