...
<?php endif; ?>
    <textarea id="<?php echo e($id); ?>" name="<?php echo e($name); ?>"<?php echo !empty($attributes) ? ' '.$attributes : ''; ?> style="visibility:hidden<?php echo e($minHeight ?? false ? ';min-height:'.$minHeight.'px' : ''); ?>"><?php echo old($name, $value ?? $slot ?? ''); ?></textarea>
<?php if($help ?? false): ?>
...
<script>
    whenAssetIsLoaded('<?php echo mix('/plugins/tinymce/tinymce.min.js', '/assets/vendor/boilerplate'); ?>', () => {
        window.<?php echo e('MCE_'.\Str::camel($id)); ?> = tinymce.init({
            selector: '#<?php echo e($id); ?>',
            toolbar_sticky: <?php echo e(($sticky ?? false) ? 'true' : 'false'); ?>,
            <?php echo e($minHeight ?? false ? 'min_height:'.$minHeight.',' : ''); ?>

            <?php echo e($maxHeight ?? false ? 'max_height:'.$maxHeight.',' : ''); ?>
...
<?php endif; ?><?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/tinymce.blade.php ENDPATH**/ ?>