        ...
        <td align="center">
            <table cellpadding="0" cellspacing="0" border="0" align="center" width="620" class="container">
                <tr>
                    <td class="mentions">
                        <small>
                            <?php echo __('boilerplate-email-editor::email.intro', ['email' => $sender_email ?? config('boilerplate.email-editor.from.address')]); ?>
                ...
                <tr>
                    <td class="mentions">
                        <small>
                            <?php echo e(__('boilerplate-email-editor::email.automatic')); ?>
...
<?php /**PATH E:\Repo\simtpu-v2\vendor\sebastienheyd\boilerplate-email-editor\src/resources/views/layout/default.blade.php ENDPATH**/ ?>