...
<?php $__env->startComponent('boilerplate::minify'); ?>
    <script>
        whenAssetIsLoaded('ColorPicker', () => {
            window.<?php echo e('CP_'.\Str::camel($id)); ?> = $('#<?php echo e($id); ?>').spectrum({
                allowEmpty:true,
                showInput: true,
                showInitial: true,
...
<?php /**PATH /Users/ilhamtaufiq/www/simtpuv2/vendor/sebastienheyd/boilerplate/src/resources/views/components/colorpicker.blade.php ENDPATH**/ ?>