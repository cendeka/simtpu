...
<meta property="og:image" content="/">
    ...
    <link
      rel="shortcut icon"
      href="{{URL::asset('assets/images/pemda.png')}}"
      type="image/svg"
    />
          ...
          <div class="col-lg-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="index.html">
                <img src="{{ URL::asset('/assets/images/pemda.png') }}" style="weight: 52px; width: 52px;" alt="Logo" />
              </a>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="ud-widget">
                <a href="index.html" class="ud-footer-logo">
                  <img src="{{ URL::asset('/assets/images/pemda.png') }}" style="height: 54px; width: 52px;" alt="logo" />
                </a>
