        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/simtpu-logo.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/simtpu-logo.png') }}" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="/" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/simtpu-logo.png') }}" alt="" height="19">
                    </span>
                </a>
            </div>
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                {{-- <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}"
                    alt="Header Avatar"> --}}
                    <img class="rounded-circle header-profile-user" src="{{ asset('/assets/images/pemda.png') }}"
                    alt="Header Avatar">
