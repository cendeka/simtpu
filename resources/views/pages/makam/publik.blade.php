                    ...
                    <div class="col">
                        <div class="row mb-3">
                            <div class="col-md-12 text-end">
                                <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->color(255, 0, 0)->merge('/public/assets/images/pemda.png')->size(200)->generate("".env('APP_URL')."/makam/info?kode_registrasi=".$data->registrasi->kode_registrasi."")) !!} ">
                            </div>
                        </div>
                    </div>
                </div> -->
