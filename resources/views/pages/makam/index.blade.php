...
@section('script')
    ...
    <script>
        $("document").ready(function() {
            ...
            $("#datatable").dataTable({
                language: {
                    searchPlaceholder: "Cari nama makam, tahun, blok, kode registrasi",
                    sSearch: "Cari",
                    info: "Menampilkan _START_ sampai _END_ of _TOTAL_ data",
                    paginate: {
                        first: "Pertama",
                        last: "Terkhir",
                        next: "Selanjutnya",
            ...
            $("#datatable_filter.dataTables_filter").append($("#categoryFilter, #namaTpu"));
